...
public class MapBodyManager {
    ...
    public MapBodyManager(World world, float unitsPerPixel, FileHandle materialsFile, int loggingLevel) {
        ...
        defaultFixture.filter.categoryBits = 4;
        defaultFixture.filter.maskBits = -1;
    ...
    public void createPhysics(Map map) {
        createPhysics(map, "physics", false);
    }
     ...
     */
    public void createPhysics(Map map, String layerName, boolean isCurrentHole) {
        ...
        while(objectIt.hasNext()) {
            ...
            if(!object.getName().equals("hole")) {
                body.setUserData(new TileType("tile"));
            }else{
                if(isCurrentHole){
                    body.setUserData(new TileType("hole"));
                }else{
                    body.setUserData(new TileType("tile"));
                }
            }
